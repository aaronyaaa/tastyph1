...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $userId = $_SESSION['userId'] ?? null; // Adjusted to user_id
    ...
    $targetDir = "../image/"; // Ensure this directory exists and is writable
    ...
    if ($uploadOk) {
        ...
        $stmt = $conn->prepare("
            INSERT INTO apply_supplier (supplier_id, business_name, description, address, business_permit, health_permit, status) 
            VALUES (?, ?, ?, ?, ?, ?, 'pending')
        ");
